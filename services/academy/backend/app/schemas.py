...
class UserOut(BaseModel):
    ...
    zoom_meetings: Optional[List["ZoomMeetingOut"]] = None
...
# ----------------- Zoom Meeting -----------------
class ZoomMeetingBase(BaseModel):
    meeting_url: str
    topic: str
    start_time: datetime
...
class ZoomMeetingCreate(ZoomMeetingBase):
    pass


# Minimal timetable for embedding in ZoomMeetingOut
class TimetableMinimalOut(BaseModel):
    id: int
    day: str
    period: Optional[int]
...
class ZoomMeetingOut(ZoomMeetingBase):
    id: int
    host: Optional["BasicUserOut"] = None
    timetable_slot: Optional[TimetableMinimalOut] = None  # ✅ safe minimal version
...
class TimetableOut(BaseModel):
    ...
    zoom_meeting: Optional[ZoomMeetingOut] = None  # ✅ full ZoomMeetingOut here
...
MeResponse = Union[UserOut, StudentProfileOut, TeacherProfileOut, ParentProfileOut]


# -------------------- Rebuild Models to Resolve Forward References --------------------
# This is crucial for Pydantic v2.
TimetableOut.model_rebuild()
ZoomMeetingOut.model_rebuild()
UserOut.model_rebuild()
TeacherProfileOut.model_rebuild()
StudentProfileOut.model_rebuild()
ParentChildAssociationOut.model_rebuild()
ParentProfileOut.model_rebuild()
