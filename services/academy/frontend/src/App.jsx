...
import StudentZoomClassesPage from './pages/StudentZoomClassesPage';
...
import AdminZoomClassesPage from './pages/AdminDashboard/AdminZoomClassesPage';
...
import ZoomClassPage from './pages/TeacherDashboard/ZoomClassPage';
...
const LogoutPage = () => {
  ...
  useEffect(() => {
    ...
    // ✅ CORRECTED: Redirect to the correct base path for the Academy service
    ...
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <NotificationProvider>
          <ToastifyToaster />
          <SonnerToaster />
          {/* ✅ CORRECTED: Add the basename for the Academy service */}
          <Router basename="/academy">
            <Routes>
              ...
              <Route element={<ResponsiveLayout />}>
                ...
                <Route path="/ask-anything" element={<PrivateRoute><AskMeAnythingPage /></PrivateRoute>} />
                <Route path="/tests/:subject/:testType" element={<PrivateRoute><TestQuizPage /></PrivateRoute>} />
                <Route path="/exam/:subject" element={<PrivateRoute><ExamPage /></PrivateRoute>} />
                <Route path="/assignments" element={<PrivateRoute><StudentSubmissionPage /></PrivateRoute>} />
                <Route path="/student/zoom-classes" element={<PrivateRoute><StudentZoomClassesPage /></PrivateRoute>} />
                ...
                <Route path="/admin-dashboard" element={<AdminRoute><AdminDashboardLayout /></AdminRoute>}>
                  ...
                  <Route path="zoom-classes" element={<RequireAdmin><AdminZoomClassesPage /></RequireAdmin>} />
                </Route>
                ...
                <Route path="/teacher/zoom-classes" element={<RequireTeacher><ZoomClassPage /></RequireTeacher>} />
